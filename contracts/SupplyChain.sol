...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  modifier verifyCaller (address _address) { require (msg.sender == _address, "caller should be the sender"); _;}

  modifier paidEnough(uint _price) { require(msg.value >= _price, "value should be greater or equal to the price"); _;}
